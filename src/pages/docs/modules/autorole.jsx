...
export default function AutoRole() {
	return (
		<>
			...
			<p>To activate this module, you must issue the command <b>!modules</b>, then select <b><img src="/cdn/img/emote/member.png" alt="emote" /> autorole</b> and finally by sending the message starting with the mention of the role</p>
