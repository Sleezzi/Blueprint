...
export default function GetRecovery() {
    return (
        <>
            ...
            <h2>Enable</h2>
            <p>To activate this module, you must issue the command <b>!modules</b>, then select <img src="/cdn/img/emote/exit.gif" alt="emote" /> and finally by sending the message starting with the mention of the channel</p>
