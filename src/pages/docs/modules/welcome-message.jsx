...
export default function WelcomeMessge() {
	return (
		<>
			<h1>RedEye - Modules: Welcome Message</h1>
			...
			<h2>Enable</h2>
			<p>To activate this module, you must issue the command <b>!modules</b>, then select <b>📥 welcome</b> and finally by sending the message starting with the mention of the channel</p>
