...
export default function Docs() {
    return (
        <>
            ...
            <p>RedEye is an OpenSource bot, its code can be found on <a href="https://github.com/Sleezzi/RedEye">Github</a>, however, its development <a href="https://sleezzi. fr">Sleezzi</a> sometimes you don't follow this logic and make code a little complicated. This is why this step is here, it allows you to better understand how the bot was designed and how it works.</p>
